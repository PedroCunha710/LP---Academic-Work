 ...
 * @param ClientList and ReservationList is used to send the adress of the mains variables "clients" and "reservations" to the following functions.
 * @return This function does not return any value.Its only show the options.
 */
 ...
 * @param reservation_id The reservation id valid integer value.
 * @return This function does not return any value.Its only show the options.
 */
 ...
 * @return This function does not return any value.Its only show the options.
 */
void menuReservationReports(ReservationList *list);
